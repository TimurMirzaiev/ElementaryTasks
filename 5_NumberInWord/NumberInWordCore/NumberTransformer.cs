...
namespace _5_NumberInWord.NumberInWordCore
{
    public class NumberTransformer
    {
        ...
        public static string Str(int val)
        {
            ...
            if (n % 1000 != 0)
            {
                r.Append(NumberTransformer.Str(n, true, "", "", ""));
            }
            n /= 1000;

            r.Insert(0, NumberTransformer.Str(n, false, "тысяча", "тысячи", "тысяч"));
            n /= 1000;

            r.Insert(0, NumberTransformer.Str(n, true, "миллион", "миллиона", "миллионов"));
            n /= 1000;

            r.Insert(0, NumberTransformer.Str(n, true, "миллиард", "миллиарда", "миллиардов"));
            n /= 1000;

            r.Insert(0, NumberTransformer.Str(n, true, "триллион", "триллиона", "триллионов"));
            n /= 1000;

            r.Insert(0, NumberTransformer.Str(n, true, "триллиард", "триллиарда", "триллиардов"));
